...
(function () {
  ...
  const en = {
    ...
    dom: {
      ...
      "problema.p2": "Copying WhatsApp orders into Excel. Answering the same thing fifty times. A template website that brings no customers. Those hours aren't your business: they're friction. Move the sliders and see what it costs you every month.",
      ...
      "servicios.p2": "Every service is quoted by outcome, not by the hour. We tell you what fits you, not what bills the most.",
      "servicios.h31": "Websites that sell",
      "servicios.p3": "Landing pages and company sites with one goal: turning a visit into a WhatsApp message, a quote or a booking. Fast, on your own domain and ready for Google.",
      "servicios.a1": "See delivered sites →",
      "servicios.h32": "Automation",
      "servicios.p4": "Flows that move information on their own: orders landing in your sheet or system, automatic WhatsApp replies, reminders, a report every morning. First we tidy up the process, then we automate it.",
      "servicios.h33": "Custom systems",
      "servicios.p5": "From the Excel sheet to the system that actually runs your business: inventory, customers, quotes, scheduling, invoices, users with permissions. Built around how you work, not the other way round.",
      "servicios.h34": "Data & API integration",
      "servicios.p6": "We connect your system to sources that resist: government portals with no API, job boards, suppliers, banks. We've integrated nine Ecuadorian public sources into a single query and reverse-engineered three undocumented APIs.",
      "servicios.h35": "Desktop apps & local AI",
      "servicios.p7": "Applications that run on your computer without internet or accounts: point-of-sale tools, internal utilities, AI assistants that never send your data anywhere.",
      "servicios.h36": "Maintenance & support",
      "servicios.p8": "After delivery we stay by your side: domain, hosting, backups, content changes and improvements. If something goes down, we bring it back. You focus on your business.",
      "proceso.p1": "How we work",
      "proceso.h21": 'No surprises, <span class="serif">from start</span> to finish',
      "proceso.p2": "A short, visible process. You know what will be built, what it costs and when you'll have it before the first line is written.",
      "steps.h31": "Diagnosis",
      "steps.p1": "A WhatsApp or video conversation. You tell us how you work today and where time or customers get lost. It is not a sales call.",
      "steps.span1": "Free · 30 min",
      "steps.h32": "Fixed proposal",
      "steps.p2": "You get in writing what gets built, how long it takes and at what fixed price. If the scope doesn't change, neither does the price.",
      "steps.span2": "Within 48 h",
      "steps.h33": "Visible build",
      "steps.p3": "From week one you have a link where you see real progress. We adjust along the way, not at the end.",
      "steps.span3": "Weeks, not months",
      "steps.h34": "Delivery & follow-up",
      "steps.p4": "We publish on your domain, hand over access and code, and show you how to use it. Then we stay by your side with support.",
      "steps.span4": "Support included",
      "trabajos.p1": "Live work",
      "trabajos.h21": 'Built for <span class="accent">real businesses</span>',
      "trabajos.p2": "Five Ecuadorian businesses already get customers through sites built by CODUV. All in production: open them and see for yourself.",
